...
class PrintReceiveComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.receive-stock.print-receive-component',compact('matterail','logistic'))->layout('layouts.base');
    }
}
