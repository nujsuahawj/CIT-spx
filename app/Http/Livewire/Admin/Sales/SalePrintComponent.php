...
class SalePrintComponent extends Component
{
    public $hidenId;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.sales.sale-print-component', compact('sales','saleDetails','sum_qty_sale_detail','sum_price_sale_detail','sum_discount_sale_detail',
