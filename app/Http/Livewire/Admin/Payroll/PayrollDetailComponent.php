...
class PayrollDetailComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.payroll.payroll-detail-component', compact('payrolls','payrolldetails','sum_total_amount','sum_total_bonus'))->layout('layouts.base');
    }
}
