...
class PrintReceiveBranchComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.receive-branch.print-receive-branch-component',compact('matterail','logistic'))->layout('layouts.base');
    }
}
