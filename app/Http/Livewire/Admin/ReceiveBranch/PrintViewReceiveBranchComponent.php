...
class PrintViewReceiveBranchComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.receive-branch.print-view-receive-branch-component',compact('matterail','logistic'))->layout('layouts.base');
    }
}
