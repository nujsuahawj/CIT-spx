...
{
    use HasFactory;
    protected $fillable = ['id','code','receive_id','goods_id','product_type_id','large','height','longs','weigh','cal_id','currency_code','amout','paid_type','cod_amount','insur_amount','branch_id','status'];
