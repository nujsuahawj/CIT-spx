                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="code" value="{{$branch->code}}" class="form-control {{ $errors->has('code') ? ' is-invalid' : '' }}" placeholder="{{__('lang.branchname')}}">
                                @if ($errors->has('code'))
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="company_name_la" value="{{$branch->company_name_la}}" class="form-control {{ $errors->has('company_name_la') ? ' is-invalid' : '' }}" placeholder="{{__('lang.branchname')}}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="company_name_en" value="{{$branch->company_name_en}}" class="form-control {{ $errors->has('company_name_en') ? ' is-invalid' : '' }}" placeholder="{{__('lang.branchname')}}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 {{ $errors->has('branch_type_id') ? ' is-invalid' : '' }}" name="branch_type_id" style="width: 100%;">   
                                  ...
                                  @foreach($branch_type as $item)
                                        <option
                                            @if ($branch->branch_type_id == $item->id)
                                                {{'selected'}}
                                            @endif 
                                            value="{{$item->id}}">{{$item->name}}
                                        </option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 {{ $errors->has('dividend_id') ? ' is-invalid' : '' }}" name="dividend_id" style="width: 100%;">   
                                  ...
                                  @foreach($dividends as $item)
                                        <option
                                            @if ($branch->dividend_id == $item->id)
                                                {{'selected'}}
                                            @endif 
                                            value="{{$item->id}}">{{$item->name}} {{$item->percent}}
                                        </option>
                                  @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="sign1" value="{{$branch->sign1}}" class="form-control {{ $errors->has('sign1') ? ' is-invalid' : '' }}" placeholder="{{__('lang.sign1')}}" >
                                @if ($errors->has('sign1'))
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="sign2" value="{{$branch->sign2}}" class="form-control {{ $errors->has('sign2') ? ' is-invalid' : '' }}" placeholder="{{__('lang.sign2')}}" >
                                @if ($errors->has('sign2'))
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="sign3" value="{{$branch->sign3}}" class="form-control {{ $errors->has('sign3') ? ' is-invalid' : '' }}" placeholder="{{__('lang.sign3')}}" >
                                @if ($errors->has('sign3'))
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="sign4" value="{{$branch->sign4}}" class="form-control {{ $errors->has('sign4') ? ' is-invalid' : '' }}" placeholder="{{__('lang.sign4')}}" >
                                @if ($errors->has('sign4'))
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="whatsapp" value="{{$branch->whatsapp}}" class="form-control {{ $errors->has('whatsapp') ? ' is-invalid' : '' }}" placeholder="{{__('lang.whatsapp')}}" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="facebook_fanpage" value="{{$branch->facebook_fanpage}}" class="form-control {{ $errors->has('facebook_fanpage') ? ' is-invalid' : '' }}" placeholder="{{__('lang.facebook_fanpage')}}" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="longitude" value="{{$branch->longitude}}" class="form-control {{ $errors->has('longitude') ? ' is-invalid' : '' }}" placeholder="{{__('lang.longitude')}}" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="latitude" value="{{$branch->latitude}}" class="form-control {{ $errors->has('latitude') ? ' is-invalid' : '' }}" placeholder="{{__('lang.latitude')}}" >
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="active">
                                    <option value="1" {{$branch->active == 1 ? 'selected' : ''}}>{{ __('blog.active') }}</option>
                                    <option value="0" {{$branch->active == 0 ? 'selected' : ''}}>{{ __('blog.inactive') }}</option>
                                </select>
                            </div>
                        </div>
                    </div>
