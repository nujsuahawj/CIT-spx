    ...
    <div class="container-fluid">
        <div class="col-lg-12">
          <div class="card card-default">
            ...
            <form method="POST" action="{{route('local_doc.update', $local_doc->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control {{ $errors->has('date') ? ' is-invalid' : '' }}" name="date" value="{{$local_doc->date}}" placeholder="{{__('doc.date')}}">
                            @if ($errors->has('date'))
                      ...
                      <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ $errors->has('short_title') ? ' is-invalid' : '' }}" name="short_title" value="{{$local_doc->title}}" placeholder="{{__('doc.short_title')}}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 {{ $errors->has('storage_file_id') ? ' is-invalid' : '' }}" name="storage_file_id" style="width: 100%;"> 
                                  ...
                                  @foreach($storage as $store)
                                    <option 
                                    @if($local_doc->storage_id == $store->id)
                                        {{'selected'}}
                                    @endif
