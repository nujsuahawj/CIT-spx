                      ...
                      <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control {{ $errors->has('doc_no') ? ' is-invalid' : '' }}" name="doc_no" placeholder="{{__('doc.doc_no')}}" autofocus>
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_doc" placeholder="{{__('doc.no_doc')}}">
                          </div>
                        </div>
                        <div class="col-md-2">
                          <div class="form-group">
                            <label for="date_doc">{{__('doc.date_doc')}}</label>
                            <input type="date" class="form-control" name="date_doc" placeholder="{{__('doc.date_doc')}}">
                          </div>
                        </div>
                      </div>
