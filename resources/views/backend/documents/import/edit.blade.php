          ...
          <div class="card card-default">
            ...
            <form method="POST" action="{{route('import_doc.update', $import_doc->id)}}" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control {{ $errors->has('doc_no') ? ' is-invalid' : '' }}" name="doc_no" value="{{$import_doc->code}}" placeholder="{{__('doc.doc_no')}}">
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control {{ $errors->has('date') ? ' is-invalid' : '' }}" name="date" value="{{$import_doc->date}}" placeholder="{{__('doc.date')}}">
                            @if ($errors->has('date'))
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            <label for="no_doc">{{__('doc.no_doc')}}</label>
                            <input type="text" class="form-control" name="no_doc" value="{{$import_doc->doc_no}}" placeholder="{{__('doc.no_doc')}}">
                          </div>
                        </div>
                        <div class="col-md-2">
                          <div class="form-group">
                            <label for="date_doc">{{__('doc.date')}}</label>
                            <input type="date" class="form-control" name="date_doc" value="{{$import_doc->doc_date}}" placeholder="{{__('doc.date_doc')}}">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ $errors->has('short_title') ? ' is-invalid' : '' }}" name="short_title" value="{{$import_doc->title}}" placeholder="{{__('doc.short_title')}}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 {{ $errors->has('depart_id') ? ' is-invalid' : '' }}" name="depart_id" style="width: 100%;">  
                                  ...
                                  @foreach($depart as $dp)
                                    <option 
                                        @if($import_doc->external_id == $dp->id)
                                            {{'selected'}}
                                        @endif
                                        value="{{$dp->id}}">{{$dp->name}}
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 {{ $errors->has('storage_file_id') ? ' is-invalid' : '' }}" name="storage_file_id" style="width: 100%;">  
                                  ...
                                  @foreach($storage as $store)
                                    <option 
                                        @if($import_doc->storage_id == $store->id)
                                            {{'selected'}}
                                        @endif
                ...
                <div class="card-footer">
                    ...
                    <a class="btn btn-warning" href="{{route('import_doc.index')}}" >{{__('doc.back')}}</a>
                </div>
            </form>
