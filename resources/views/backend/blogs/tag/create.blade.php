                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="text" name="name_la" class="form-control {{ $errors->has('name_la') ? ' is-invalid' : '' }}" placeholder="{{__('lang.departname')}}" autofocus>
                    ...
                    <div class="col-md-6">
                        <div class="form-group"> 
                          ...
                          <input type="text" name="name_en" class="form-control {{ $errors->has('name_en') ? ' is-invalid' : '' }}" placeholder="{{__('lang.departname')}}" >
