                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                <img src="{{asset($testimonial->image)}}" height="10%" width="10%">
                            </div>
                        </div>
                    </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status">
                                <option value="1" {{$testimonial->status == 1 ? 'selected' : ''}}>{{ __('blog.active') }}</option>
                                <option value="0" {{$testimonial->status == 0 ? 'selected' : ''}}>{{ __('blog.inactive') }}</option>
                            </select>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{$testimonial->name}}" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" >
                            @if ($errors->has('name'))
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="position" value="{{$testimonial->position}}" class="form-control">
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" name="des_la" class="form-control {{ $errors->has('des_la') ? ' is-invalid' : '' }}" > {{$testimonial->des_la}} </textarea>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="des_en" value="{{$testimonial->des_en}}" class="form-control"> {{$testimonial->des_en}} </textarea>
                            </div>
                        </div>
                    </div>
                </div>
