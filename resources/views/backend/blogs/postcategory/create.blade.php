            ...
            <form method="POST" action="{{route('postcategory.store')}}">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="name">{{__('blog.postcategory')}} ({{__('lang.lao')}})</label>
                                <input type="text" name="name_la" class="form-control {{ $errors->has('name_la') ? ' is-invalid' : '' }}" placeholder="{{__('blog.postcategory')}}" autofocus>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="name">{{__('blog.postcategory')}} ({{__('lang.en')}})</label>
                                <input type="text" name="name_en" class="form-control {{ $errors->has('name_en') ? ' is-invalid' : '' }}" placeholder="{{__('blog.postcategory')}}" autofocus>
