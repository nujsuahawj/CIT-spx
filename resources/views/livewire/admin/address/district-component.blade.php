                        ...
                        <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input wire:model="name" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="{{__('lang.districtname')}}">
...
@push('scripts')
  ...
  $('#select_fill').select2();
  $('#select_fill').on('change', function (e) {
      var data = $('#select_fill').select2("val");
