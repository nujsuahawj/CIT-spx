        ...
        <div class="col-12">
          ...
          <div class="invoice p-2 mb-2 mt-2">
            ...
            <div class="row no-print">
              <div class="col-12">
                    <a href="{{route('admin.print_view_receive_branch', $logistic->id)}}" rel="noopener" target="_blank" class="btn btn-info"><i class="fas fa-print"></i> {{__('lang.printa4')}}</a>
                    <a href="{{route('admin.receive_branch')}}" class="btn btn-warning float-right"><i class="fas fa-arrow-alt-circle-left"></i> {{__('lang.back')}}</a>
              </div>
            </div>
          </div>
          <!-- /.invoice -->
