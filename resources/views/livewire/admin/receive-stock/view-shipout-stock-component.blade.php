<div>
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>{{__('lang.list_shipout_stock')}}</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('lang.home')}}</a></li>
                <li class="breadcrumb-item active">{{__('lang.list_shipout_stock')}}</li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <div class="row">
                    <div class="col-md-3">
                      <a href="{{route('admin.create_shipout_stock')}}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> {{__('lang.create')}}</a>
                      <a href="{{route('admin.receive_stock')}}" class="btn btn-info btn-sm"><i class="fas fa-list-ol"></i> {{__('lang.back_to_receive_stock')}}</a>
                    </div>
                    <div class="col-md-6">
