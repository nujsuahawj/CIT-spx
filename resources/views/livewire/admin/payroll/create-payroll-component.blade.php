                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <thead>
                                    ...
                                    $stt = 1;    
                                    @endphp
                                     @foreach ($payrolltransections as $item)
                                        <tr>
                                            <td>{{$stt++}}</td>
                                            <td>
                                            ...
                                            <td align="center">
                                                ...
                                                &emsp;
                                                <a href="javascript:void(0)" wire:click="showDeleteList({{$item->id}})"><i class="fa fa-trash text-danger"></i></a>
                                            </td>
                                        </tr>
                                     @endforeach
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td style="text-align: right"><h6><b>{{number_format($sum_total_bonus)}}</b></h6></td>
                                            <td style="text-align: right"><h6><b>{{number_format($sum_total_amount+$sum_total_bonus)}}</b></h6></td>
 ...
 <div wire:ignore.self class="modal fade" id="modal-delete">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-between">
            <button wire:click="deletePayrollList" type="button" class="btn btn-danger">{{__('lang.delete')}}</button>
