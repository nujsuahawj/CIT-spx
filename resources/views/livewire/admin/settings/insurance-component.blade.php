<div>
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>{{__('lang.insurance')}}</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('lang.home')}}</a></li>
                <li class="breadcrumb-item active">{{__('lang.insurance')}}</li>
              </ol>
            </div>
          </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                <label>{{__('lang.name')}}{{__('lang.insurance')}}</label>
                              ...
                              <div class="form-group">
                                ...
                                <input wire:model="percent" type="number" class="form-control @error('percent') is-invalid @enderror" placeholder="{{__('lang.dividend')}}">
