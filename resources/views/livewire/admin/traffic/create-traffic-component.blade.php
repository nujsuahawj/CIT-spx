                 ...
                 <div class="card-header">
                   <div class="row">
                      <div class="col-md-6">
                       ...
                       <a href="{{route('admin.traffic')}}"  type="button" class="btn btn-warning" ><i class="fas fa-arrow-alt-circle-left"></i> {{__('lang.back')}}</a>
                      </div>
                   </div>
                 </div>
                 <!--end sold button-->
...
<div class="card-body">
    ...
    <div class="row">
        <div class="col-md-8">
            <select wire:model.defer="emp_id" class="form-control @error('emp_id') is-invalid @enderror">
                <option value="">{{__('lang.select')}}</option>
    ...
    <!-- /.modal-delete -->
    <div class="modal fade" id="modal-delete-traffic">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">{{__('lang.delete')}}</h4>
          ...
          <div class="modal-footer justify-content-between">
            <button wire:click="destroyTraffic({{$hiddenIdTraffic}})" type="button" class="btn btn-danger">{{__('lang.delete')}}</button>
            <button type="button" class="btn btn-danger" data-dismiss="modal">{{__('lang.close')}}</button>
          </div>
        </div>
      </div>
