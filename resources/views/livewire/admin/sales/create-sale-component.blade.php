          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">{{__('lang.sale')}}</li>
              </ol>
            </div>
          </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <thead>
                                    ...
                                    @foreach ($saletransections as $item)
                                    <tr>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td width="15%" style="text-align: right">
                                                <label wire:model="grand_total"><h5><b>{{number_format(((($sum_total_tran - $discount_all)*$vat_all)/100)+($sum_total_tran - $discount_all))}}</b></h5></label>
                                            </td>
                                            <td width="15%"></td>
                                        </tr>
                                        <tr>
